        ...
        3379: function (t) {
          ...
          function n(t, n) {
            for (var s = {}, o = [], l = 0; l < t.length; l++) {
              ...
              if (-1 !== d) e[d].references++, e[d].updater(p);
                ...
                var h = i(p, n);
                (n.byIndex = l),
                  e.splice(l, 0, { identifier: u, updater: h, references: 1 });
              }
              o.push(u);
            }
            return o;
          ...
          t.exports = function (t, i) {
            ...
            return function (t) {
              ...
              for (var r = n(t, i), c = 0; c < s.length; c++) {
                var m = a(s[c]);
    ...
    return (
      (function () {
        ...
        var w =
          ...
          A = z.contains('layout-menu-offcanvas')
            ? 'static-offcanvas'
            ...
            function t(e) {
              ...
              if (
                ...
                if (
                  ...
                  (this.settings.displayCustomizer = void 0 === s || s),
                  ...
                  -1 !== H &&
                    (this.settings.controls = this.settings.controls
                      .slice(0, H)
                      .concat(this.settings.controls.slice(H + 1)));
                }
                    ...
                    if (
                      ...
                      'fixed-offcanvas' === this.settings.headerType
                        ? n &&
                          ...
                          (a = new n(document.querySelector('.menu-inner'), {
                            suppressScrollX: !0,
                            wheelPropagation: !1,
                          })),
                          (window.Helpers.menuPsScroll = a))
                  ...
                  value: function (e) {
                    ...
                    if (e !== this.settings.lang || n) {
                      ...
                      [
                        ...
                        var e = a.container.querySelector(
                      ...
                      for (
                        ...
                        ).textContent = s[c] || this._getThemeByName(c).title;
                      }
                ...
                },
                {
                  ...
                  value: function () {
                    var t,
                      ...
                      s = this._getSetting('contentLayout'),
                    ...
                    '' !== m
                      ...
                      (this.settings.headerType = t),
                      (this.settings.rtl =
                        '' !== a ? 'true' === a : this.settings.defaultTextDir),
                      (this.settings.stylesOpt =
                        -1 !== this.settings.styles.indexOf(n)
                          ? n
                      ...
                      (this.settings.contentLayout =
                        '' !== s ? s : this.settings.defaultContentLayout),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    n.addEventListener('click', i),
                      this._listeners.push([n, 'click', i]);
                    ...
                    s.addEventListener('click', o),
                      this._listeners.push([s, 'click', o]);
                    ...
                    if (this._hasControls('themes')) {
                      ...
                      p.addEventListener('change', h),
                        this._listeners.push([p, 'change', h]);
                    ...
                    if (
                      ...
                      if (this._hasControls('headerType')) {
                        var x = _.querySelector(
                          '.template-customizer-header-options'
                        );
                        setTimeout(function () {
                          S.includes('vertical') && _.parentNode.removeChild(_);
                        }, 100),
                        ...
                        x.addEventListener('change', w),
                          this._listeners.push([x, 'change', w]);
                      ...
                      if (this._hasControls('contentLayout')) {
                        ...
                        C.addEventListener('change', T),
                          this._listeners.push([C, 'change', T]);
                  ...
                  value: function (t) {
                    ...
                    try {
                      e = localStorage.getItem(
                        'templateCustomizer-'.concat(a, '--').concat(t)
                      );
                    } catch (t) {}
                    return String(e || '');
                  },
                  ...
                  value: function () {
                    var t = this,
                      e =
                        ...
                        arguments[0];
                    setTimeout(function () {
                      var a = t.container.querySelector(
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return t.split(' ').reduce(function (t, n) {
                      return (
                        -1 !== e.settings.controls.indexOf(n)
                          ? (a || !1 !== t) && (t = !0)
                          : (a && !0 === t) || (t = !1),
                        t
                      );
                  ...
                  value: function (t) {
                    for (
                      var e =
                          ...
                          void 0 !== arguments[1] &&
                          arguments[1],
                        a = this.settings.availableThemes,
                        n = 0,
                        i = a.length;
                      n < i;
                      n++
                    )
                      if (a[n].name === t) return a[n];
